...
SELECT UPPER(first_name) AS employee_first_name_in_uppercase FROM employees;
-- 11. Write a query to get the first three characters of each first name of all the employees in the employees table.
SELECT LEFT(first_name, 3) AS employee_first_name_first_three_letters FROM employees;
...
SELECT first_name, last_name, LENGTH(CONCAT(first_name, last_name)) AS length_of_full_name FROM employees;
...
SELECT last_name FROM employees WHERE RIGHT(LEFT(last_name, 3),1) = 'e';
