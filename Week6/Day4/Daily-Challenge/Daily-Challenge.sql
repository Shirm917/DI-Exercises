...
VALUES
	(5022, (SELECT item_id FROM items WHERE item_name = 'TV')),
	(8098, (SELECT item_id FROM items WHERE item_name = 'Table')),
	(4500, (SELECT item_id FROM items WHERE item_name = 'Sofa'));
...
SELECT * FROM get_total_price(5022);